...
python src/main.py -savedFolder 'example_data' -proportion0 1.0 -varEffect0 1.0 -Lchr 200 -LG 100 -optim 5 -varW 1 -G 10 -N 100 -Npop 10000 -h2 0.5,0.9 -nTrait 2 -nChr 5 -mu 1e-5 -nQTL 0 -varEffect 0.0 -corTrait 0.5 -signCor 'pos' >> out_genpred &
...
## suppose that we are in the folder where the results of the simulations are saved
...
ldak6 --cut-weights "$dirOUT"LDAK/simu_freq --bfile "$dirOUT"LDAK/simu2
ldak6 --calc-weights-all "$dirOUT"LDAK/simu_freq --bfile "$dirOUT"LDAK/simu2 
...
inF <- file.path(projectDir, "simulations", "example_data", "ldak", "LDAKgmat_freq.grm.raw")
stopifnot(file.exists(inF))

GRMldak <- read.table(inF)
