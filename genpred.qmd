...
```{r}
inF <- file.path("simulations", "GP1", "pedigree.txt")
...
```{r}
inF <- file.path("simulations", "GP1", "genotype.txt")
stopifnot(file.exists(inF))
...
```{r}
inF <- file.path("simulations", "GP1", "SNP_INFO.txt")
stopifnot(file.exists(inF))
...
```{r}
inF <- file.path("simulations", "GP1", "IBD.txt")
stopifnot(file.exists(inF))
